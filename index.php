<?php
$cn = mysqli_connect("localhost", "root", "", "enrollment");
                ...
                <div class="col-md-4">
                    <div class="logo">
                        <a href="">
                            ...
                            <span>Hogwart's <span id="na">School</span></span>
                        </a>
                    </div>
                </div>
    <!--================== Main menu-area ====================-->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="slide-text">
                                    <p>Words are, in my not-so-humble opinion, <br>
                                        our most inexhaustible source of magic.<br>
                                    Capable of both inflicting injury, and remedying it.

                                        <br><i>Albus Dumbledore</i>
                                    </p>
                ...
                <div class="slider-inner">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="slide-text">
                                    <p>The mind is not a book, to be opened at will and examined at leisure.

                                        <br><i>Severus Snape</i>
                                    </p>
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="widget">
                        <div class="logo">
                            ...
                            <p> It does not do to dwell on dreams and forget to live, remember that.
                ...
                <p class="copy-right">Copyright &copy;Apoorva Sah</p>
            </div>
        </div>
    </footer>
